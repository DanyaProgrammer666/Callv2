    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults.length>0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "READ_PHONE_STATE No permission granted!", Toast.LENGTH_SHORT).show();
                }
            }
        }
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults.length>0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.PROCESS_OUTGOING_CALLS) == PackageManager.PERMISSION_GRANTED) {
                        Toast.makeText(this, "PROCESS_OUTGOING_CALLS Permission granted!", Toast.LENGTH_SHORT).show();

                    }
                } else {
                    Toast.makeText(this, "PROCESS_OUTGOING_CALLS No permission granted!", Toast.LENGTH_SHORT).show();
                }
            }
        }
